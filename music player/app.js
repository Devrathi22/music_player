...
const songs =[
    ...
    {
        id: 5, 
        songName: `White Borwn Black <br> 
        <div class="subtitle">Avvy Sara | Karan Aujla | Jaani</div>`,
        poster: "images/5.jpg"
    },
    {
        id: 6, 
        songName: `Sut Down <br> 
    ...
    {
        id: 8, 
        songName: `Notorious <br> 
        <div class="subtitle">Wazir Patar</div>`,
        poster: "images/8.jpg"
    },
    {
        id: 9, 
        songName: `Kinni Kinni <br> 
    ...
    },
    {
        id: 11, 
        songName: `Spain <br> 
        <div class="subtitle">Jassa Dhillon</div>`,
    ...
    },
    {
        id: 16, 
        songName: `Lalkara <br> 
        <div class="subtitle">Diljit Dosanjh | Sultaan</div>`,
    ...
    },
    {
        id: 20, 
        songName: `Baazi <br> 
        <div class="subtitle">Supreme Sidhu | Talwinder</div>`,
...
shuffle.addEventListener('click',()=>{
    ...
    switch (a) {
        case "next":
            ...
            shuffle.classList.remove('bi-music-note-beemed')
        ...
        case "random":
            shuffle.classList.remove('bi-arrow-repeat')
            shuffle.classList.add('bi-music-note-beemed')
            shuffle.classList.remove('bi-shuffle')
